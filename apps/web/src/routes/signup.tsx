...
import { SignupReq, type AuthRes } from '@meeting-app/shared';
...
function SignupPage() {
  ...
  const {
    ...
    resolver: standardSchemaResolver(SignupReq),
  });

  const onSubmit = async (data: SignupReq) => {
    try {
      const res = await api<AuthRes>('/auth/signup', {
        method: 'POST',
      ...
      <div className="w-full max-w-sm">
        ...
        <Card variant="glass" className="shadow-xl">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription>
              Get started with AwtoMeet in seconds
            </CardDescription>
          </CardHeader>
          <CardContent>
            <form
